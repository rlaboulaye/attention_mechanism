...
class ContextEnhancedGRUCellA(GRUCell):
	...
	def __init__(self, input_dimension, hidden_dimension, context_dimension, output_activation=nn.Tanh(), gating_activation=nn.Sigmoid()):
		...
		super(ContextEnhancedGRUCellA, self).__init__(input_dimension + context_dimension, hidden_dimension, output_activation, gating_activation)
